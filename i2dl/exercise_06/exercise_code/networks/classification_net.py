...
from exercise_code.networks.layer import Dropout
...
class ClassificationNet(Network):
    ...
    def __init__(self, activation=Sigmoid(), num_layer=2,
                 ...
                 std=1e-3, num_classes=10, reg=0, dropout_prob=0.1, **kwargs):
        """
    ...
    def forward(self, X):
        ...
        for i in range(self.num_layer - 1):
            ...
            X, cache_dropout = self.dropout.forward(X)
            self.cache['dropout' + str(i + 1)] = cache_dropout
    ...
    def backward(self, dy):
        ...
        for i in range(self.num_layer - 2, -1, -1):
            ...
            cache_dropout = self.cache['dropout' + str(i + 1)]

            dh = self.dropout.backward(dh, cache_dropout)
